...
namespace Oldmansoft.ApplicationService.MoneyBag.WebApp.Controllers
{
    public class WalletExpendController : ApiController
    {
        ...
        {
            long transactionId;
            return new Application.Money().Expend(id, model.ClientAppId, model.ClientOrderId, model.Cent, model.Description, model.Callback, out transactionId);
        }
        ...
        public Models.TradeResponseModel Post(Guid id, [FromBody]Models.TradeRequestModel model)
        {
            ...
            result.State = new Application.Money().Expend(id, model.ClientAppId, model.ClientOrderId, model.Cent, model.Description, model.Callback, out transactionId);
